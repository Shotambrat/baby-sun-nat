    ...
    <footer className={cn("bg-[#F1F4F8] flex flex-col gap-4", className)}>
      <div className="w-full max-w-[1500px] px-4 mx-auto py-12 grid grid-cols-1 mdx:grid-cols-2 lgx:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm leading-5 font-medium w-full max-w-[250px]">
            г.Ташкент, ул Такая-то, проезд такой-то, дом такой-то
          </p>
          <Link
            href={"/contacts"}
            className="text-[#009FE3] flex gap-4 font-bold items-center"
          >
            Построить маршрут
            <Image
        ...
        <div className="flex flex-col gap-2">
          ...
          <a
            ...
            className="text-sm leading-5 font-medium w-full max-w-[250px]"
          >
            +998 (90) 999-99-99
          </a>
          <a
        ...
        <div className="flex flex-col gap-2">
          <h3 className="text-2xl font-semibold">График работы</h3>
          <p className="text-sm leading-5 font-medium w-full max-w-[250px]">
            8:00 - 17:00 пн-пт
          </p>
          <p className="text-sm leading-5 font-medium w-full max-w-[250px]">
      ...
      <div className="flex w-full justify-between max-w-[1500px] px-4 mx-auto py-4">
        <div className="flex gap-12 max-lgx: flex-wrap">
