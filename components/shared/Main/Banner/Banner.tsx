...
const banner = [
  {
    id: 1,
    title: "Добро пожаловать в BabySun",
    description:
      "Ваш надежный партнер в здоровье и реабилитации детей и взрослых. Высокоточные операции, профессиональные курсы и современные услуги для вашего благополучия",
  ...
  {
    id: 2,
    title: "Профессиональные курсы для медиков и специалистов",
    description:
      "Обучение современным методам: ШРОТ-терапия, Hijama & zuluk, курсы для медсестер и косметология. Повышайте квалификацию и улучшите свои навыки",
    buttonName: "Узнать больше о курсах",
    link: "/",
    bannerPhoto: "/images/main/banner/image_22.png",
  },
  {
    id: 3,
    title: "Современные медицинские услуги",
    description:
      "От хирургии и ортопедии до СПА для женщин и детского массажа. Профессиональный уход и передовые методики для вашего здоровья",
    buttonName: "Записаться на услугу",
    link: "/",
